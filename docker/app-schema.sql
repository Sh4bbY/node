...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`TodoLists` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`TodoItems` ;
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`Users_BEFORE_DELETE` $$
USE `mydb`$$
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`Posts_BEFORE_DELETE` $$
USE `mydb`$$
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`Tags_BEFORE_DELETE` $$
USE `mydb`$$
