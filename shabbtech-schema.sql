...
CREATE TABLE IF NOT EXISTS `mydb`.`Users` (
  ...
  UNIQUE INDEX `UserName_UNIQUE` (`UserName` ASC, `DeletedAt` ASC),
  UNIQUE INDEX `EmailAddress_UNIQUE` (`EmailAddress` ASC, `DeletedAt` ASC),
  UNIQUE INDEX `PasswordHash_UNIQUE` (`PasswordHash` ASC))
ENGINE = InnoDB;
